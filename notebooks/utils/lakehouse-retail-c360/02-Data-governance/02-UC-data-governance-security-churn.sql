...
GRANT SELECT ON TABLE spark_churn_users TO `analysts`;
GRANT SELECT ON TABLE spark_churn_app_events TO `analysts`;
GRANT SELECT ON TABLE spark_churn_orders TO `analysts`;

-- We'll grant an extra MODIFY to our Data Engineer
GRANT SELECT, MODIFY ON SCHEMA main.dbdemos_retail_c360_DIDayMumbai TO `dataengineers`;
