...
# MAGIC %md
# MAGIC A workflow was created as part of this demo. Open the <a dbdemos-workflow-id="init-job" href="#job/627130041713504/tasks" target="_blank">C360 Churn Workflow</a> to start exploring Databricks orchestration capabilities!
