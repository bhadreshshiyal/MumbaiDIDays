...
churn_dataset = spark.table("spark_churn_features")
...
# MAGIC
# MAGIC <a href='/sql/dashboards/a3ca488a-ffcf-45dc-b302-e5ff92b0ec14'>Open the Churn prediction DBSQL dashboard</a> | [Go back to the introduction]($../00-churn-introduction-lakehouse)
# MAGIC
