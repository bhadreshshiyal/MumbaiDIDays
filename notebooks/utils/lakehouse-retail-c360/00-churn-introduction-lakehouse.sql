...
-- MAGIC %md 
-- MAGIC Open the [Data Warehousing notebook]($./03-BI-data-warehousing/03-BI-Datawarehousing) to start running your BI queries or access or directly open the <a href="/sql/dashboards/83af5abf-94c1-4129-b7cb-962a63c4da02" target="_blank">Churn Analysis Dashboard</a>
...
-- MAGIC %md
-- MAGIC
-- MAGIC Open the <a href='/sql/dashboards/a3ca488a-ffcf-45dc-b302-e5ff92b0ec14' target="_blank">Churn prediction DBSQL dashboard</a> to have a complete view of your business, including churn prediction and proactive analysis.
