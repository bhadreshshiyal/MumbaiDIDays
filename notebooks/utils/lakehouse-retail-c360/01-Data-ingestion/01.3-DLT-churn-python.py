...
def churn_app_events():
  return (
    spark.readStream.format("cloudFiles")
      ...
      .load("/Volumes/main/dbdemos_retail_c360_DIDayMumbai/c360/events"))
...
def churn_orders_bronze():
  return (
    spark.readStream.format("cloudFiles")
      ...
      .option("cloudFiles.inferColumnTypes", "true")
      .load("/Volumes/main/dbdemos_retail_c360_DIDayMumbai/c360/orders"))
...
def churn_users_bronze():
  return (
    spark.readStream.format("cloudFiles")
      .option("cloudFiles.format", "json")
      .option("cloudFiles.inferColumnTypes", "true")
      .load("/Volumes/main/dbdemos_retail_c360_DIDayMumbai/c360/users"))
...
#                                                                                   Model name               |        
#                                                                                       |                    |        
predict_churn_udf = mlflow.pyfunc.spark_udf(spark, "models:/main.dbdemos_retail_c360_DIDayMumbai.dbdemos_customer_churn@prod", "int")
