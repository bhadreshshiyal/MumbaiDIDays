...
# MAGIC To run this demo, just select the cluster `dbdemos-lakehouse-retail-c360-bhadresh_shiyal` from the dropdown menu ([open cluster configuration](https://e2-demo-field-eng.cloud.databricks.com/#setting/clusters/0508-103204-out1u9ae/configuration)). <br />
...
# MAGIC %sql 
# MAGIC LIST '/Volumes/main/dbdemos_retail_c360_DIDayMumbai/c360/users'

# COMMAND ----------

# DBTITLE 1,Review the raw user data received as JSON
# MAGIC %sql
# MAGIC SELECT * FROM json.`/Volumes/main/dbdemos_retail_c360_DIDayMumbai/c360/users`
...
# MAGIC
# MAGIC
# MAGIC Switch to Databricks SQL to see how this data can easily be requested using <a href='/sql/dashboards/a3ca488a-ffcf-45dc-b302-e5ff92b0ec14' target="_blank">Churn prediction DBSQL dashboard</a>, or an external BI tool. 
# MAGIC
